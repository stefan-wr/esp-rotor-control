      ...
      >
        ...
        <g>
          ...
          <path
            id="cmp-ol-indicator"
            :style="
              settingsStore.isLockedByElse && props.isInteractive
        ...
        <g
          ...
          v-if="rotorStore.hasTarget && props.isInteractive"
